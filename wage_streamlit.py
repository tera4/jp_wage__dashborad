...
df_ts_mean = df_ts_mean.rename(columns={'一人当たり賃金（万円）':'全国_一人当たりの賃金（万円）'})
...
df_mean_line = df_mean_line[['集計年','全国_一人当たりの賃金（万円）','一人当たり賃金（万円）']]
#列をindexに変更
df_mean_line = df_mean_line.set_index('集計年')
st.line_chart(df_mean_line)

st.header('■年齢階級別の全国賃金一人当たり平均賃金（万円）')
